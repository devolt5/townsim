...
function Sidebar({
  ...
  return (
    <div
      className="group peer flex h-full shrink-0 text-sidebar-foreground"
      data-state={state}
    ...
    >
      <div
        ...
        {...props}
      >
        {/* Absolute inner so clip direction is correct per side */}
        <div
          data-sidebar="sidebar"
          data-slot="sidebar-inner"
          className={cn(
            "absolute inset-y-0 flex h-full min-w-(--sidebar-width) flex-col bg-sidebar",
